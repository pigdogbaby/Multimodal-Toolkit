...
def hf_loss_func_impute(inputs, classifier, cat_feats, numerical_feats, cat_offsets, cat_heads, numerical_heads, cat_mask, numerical_mask, alpha):
    ...
    for i, cat_head in enumerate(cat_heads):
        ...
        loss += alpha * ce(cat_logit, cat_label)
    ...
    for i, numerical_head in enumerate(numerical_heads):
        ...
        loss += (1 - alpha) * mse(numerical_logit, numerical_label)
